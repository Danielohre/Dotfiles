...
local function symbol_info()
	...
	local clangd_client = vim.lsp.get_clients({ bufnr = bufnr, name = 'clangd', method = 'textDocument/symbolInfo' })
		[1]
...
vim.lsp.config.clangd = {
	...
	on_attach = function()
		...
		vim.keymap.set('n', '<leader>h', function() switch_source_header() end)
	end,
}
